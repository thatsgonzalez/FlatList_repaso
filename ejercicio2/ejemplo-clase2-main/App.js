...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    if(clientes.length>0){
      nid = clientes[clientes.length-1].id+1;
    }
    else{
      nid = 1;
    }
    const nuevoCliente = { id: nid, nombre: nombre, carnet: carnet, materia: materia, fechaReserva: fechaReserva };
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Button title="Agregar Alumno" onPress={agregarCliente} />
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.clienteNombre}>{item.materia}</Text>
